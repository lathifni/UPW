<x-layouts.app>
    ...
    <section class="wakaf-hero" style="padding-top: 88px;">
        ...
        <div class="container position-relative z-index-1 text-center">
            <h1 class="display-4 fw-bold mb-2">{{($program->title)}}</h1>
                ...
                <div class="card border-success shadow-sm">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Kategori Wakif</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">NIM/NIP/NIKU (Opsional)</label>
                                <input type="text" name="donor_nomor_induk" class="form-control" 
                                       value="{{ auth()->user()->nomor_induk ?? '' }}" placeholder="201152..." maxlenght=20>
                            </div>
